module.exports = class Data1661950734477 {
  name = 'Data1661950734477'

  async up(db) {
    await db.query(`CREATE TABLE "asset" ("id" character varying NOT NULL, "status" character varying(11) NOT NULL, CONSTRAINT "PK_1209d107fe21482beaea51b745e" PRIMARY KEY ("id"))`)
